<ul id="nav" class="sf-menu">
							<li class="<?php if($current_page == 'home') echo "current-menu-item";?>"><a href="home">Home<span class="subheader">Welcome</span></a></li>
                            ...
                            <ul>
                                    <li class="<?php if($current_page == 'portfolio') echo "current-menu-item";?>"><a href="portfolio"><span>Portfolio </span></a></li>
                                    <li class="<?php if($current_page == 'case') echo "current-menu-item";?>"><a href="case"><span>Case Studies </span></a></li>
                                    </ul>
                                    </li>
							<li class="<?php if($current_page == 'about') echo "current-menu-item";?>"><a href="about">About Us<span class="subheader">Who we are</span></a>
								
							</li>
							<li class="<?php if($current_page == 'contact') echo "current-menu-item";?>"><a href="contact">Contact<span class="subheader">Get in touch</span></a></li>
                            <li class="<?php if($current_page == 'quote') echo "current-menu-item";?>"><a href="quote">Get A Quote<span class="subheader">Let us help</span></a></li>
						</ul>